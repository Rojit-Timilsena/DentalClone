          ...
          <div className="row g-5 pt-4">
            ...
            <div className="col-lg-3 col-md-6">
              ...
              <div className="d-flex">
                ...
                <a className="btn btn-lg btn-primary btn-lg-square rounded me-2" href="#" rel="noopener noreferrer"><i className="fab fa-facebook-f fw-normal"></i></a>
                <a className="btn btn-lg btn-primary btn-lg-square rounded me-2" href="#"><i className="fab fa-linkedin-in fw-normal"></i></a>
                <a className="btn btn-lg btn-primary btn-lg-square rounded me-2" href="#" rel="noopener noreferrer"><i className="fab fa-instagram fw-normal"></i></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row g-0">
            <div className="col-md-6 text-center text-md-start">
              <p className="mb-md-0">&copy; <a className="text-white border-bottom" href="https://digitalassistant.netlify.app/" target="_blank" rel="noopener noreferrer">SuhaasDentalClinic</a>. All Rights Reserved.</p>
            </div>
